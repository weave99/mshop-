                    ...
                    <div class="ibox invoice">
                        <div class="invoice-header">
                            <h1 class="text-center">Invoice</h1>
                                <div class="row p-2" style="background-color:#e9ecef;">
                                    <div class="col-lg-6">
                                        Invoice No. : <?php echo $order_details['transaction_id'];?>
                                    </div>
                        ...
                        <table class="table table-striped no-margin table-invoice">
                            ...
                            <?php
                                ...
                                <tr>
                                    <td>
                                        <div><strong><?php echo $f['prod_name'];?></strong></div><small>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</small></td>
                                    <td><?php echo $qty1;?></td>
