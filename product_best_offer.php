...
<html class="no-js" lang="">
    <head>
        ...
        <title>MONDAL BHANDER | BEST OFFER</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <?php
                                    ...
                                    $prod_best_sql="SELECT * FROM web_prd_manage_product_details  WHERE prod_best=1";
                                    $best_query=mysqli_query($conn,$prod_best_sql);
                                        ...
                                        <div class="col-xl-2 col-md-4 col-sm-6 col-4">
                                            <div class="sp-product-item mb-20">
                                                ...
                                                <div class="sp-product-content">
                                                    ...
                                                    <h6 class="title search_page_padding"><a href="product_details.php?prod_id=<?php echo $best_product['prod_id'];?>"><?php echo $best_product['prod_name'];?></a></h6>
